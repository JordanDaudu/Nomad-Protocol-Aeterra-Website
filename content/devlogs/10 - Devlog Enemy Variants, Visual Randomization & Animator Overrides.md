...
## 🏗 Implementation
### 🎭 Updated enemy model + animation setup
...
![Enemy Melee Visuals](/devlog-assets/10_4.png)

---

### 🎨 `EnemyVisuals` system (randomization + setup)
...
![Enemy Melee Visuals Demo](/devlog-assets/10_1.mp4)

---

### ⚔️ Weapon models as “variant carriers”
...
### 📦 Attack data moved to ScriptableObjects
...
### 🥋 Dodge enemy uses unarmed attacks
...
![Enemy Melee Dodge Type With Visual Effects](/devlog-assets/10_3.mp4)

---

### ✨ Weapon trail effect during attacks
...
![Weapon Trail Effect Demo](/devlog-assets/10_2.mp4)
